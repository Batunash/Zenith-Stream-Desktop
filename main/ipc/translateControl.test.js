...
describe('translateControl', () => {
  beforeEach(() => {
    ...
    if (translator.extractSubtitleToSrt.mockResolvedValue) {
      translator.extractSubtitleToSrt.mockResolvedValue(
        '1\n00:00:01,000 --> 00:00:02,000\nHello\n'
      );
    } else {
      translator.extractSubtitleToSrt = vi
        .fn()
        .mockResolvedValue('1\n00:00:01,000 --> 00:00:02,000\nHello\n');
    }
    ...
    if (translator.translateSrt.mockImplementation) {
      ...
      translator.translateSrt = vi
        .fn()
        .mockImplementation(async (srt, lang, provider, key, onProgress) => {
          onProgress({ stage: 'translate', percent: 50 });
          return '1\n00:00:01,000 --> 00:00:02,000\nMerhaba\n';
        });
    }

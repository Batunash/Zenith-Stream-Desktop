...
describe('handlesettings', () => {
    ...
    describe('getSettings', () => {
        ...
        it('returns default config if parsing fails', () => {
            fs.existsSync.mockReturnValueOnce(true);
            fs.readFileSync.mockImplementationOnce(() => { throw new Error('SyntaxError'); });
    ...
    describe('moveArchiveContents', () => {
        ...
        it('moves directory contents properly', () => {
            ...
            expect(fs.rmSync).toHaveBeenCalledWith(expect.stringContaining('subdir'), { recursive: true, force: true });
        });
        ...
        it('throws friendly error on failure', () => {
            ...
            fs.copyFileSync.mockImplementationOnce(() => { throw new Error('EBUSY'); });

            expect(() => {
                moveArchiveContents('C:\\old', 'C:\\new');
            }).toThrow('locked.mp4 kullanımda veya kilitli olduğu için taşınamadı. Lütfen açık videoları kapatın.');
        });
    });
});

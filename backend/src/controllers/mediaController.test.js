...
require.cache[_mediaSvcPath] = { id: _mediaSvcPath, filename: _mediaSvcPath, loaded: true, exports: mediaMocks, children: [], paths: [] };
...
describe('Media Controller', () => {
    ...
    describe('listSeries', () => {
        ...
        it('handles exceptions gracefully', async () => {
            mediaMocks.getSeries.mockImplementationOnce(() => { throw new Error('DB Crash'); });
            await listSeries(mockReq, mockRes);
    ...
    describe('getSeriesEpisodes', () => {
        ...
        it('handles exceptions gracefully', async () => {
            mockReq.params.seriesId = '123';
            mediaMocks.getEpisodesBySeries.mockImplementationOnce(() => { throw new Error('Crash'); });
            await getSeriesEpisodes(mockReq, mockRes);
            expect(mockRes.status).toHaveBeenCalledWith(500);

...
require.cache[_watchSvcPath] = {
  id: _watchSvcPath,
  filename: _watchSvcPath,
  loaded: true,
  exports: watchMocks,
  children: [],
  paths: [],
...
describe('Watch Controller', () => {
  ...
  describe('startWatch', () => {
    ...
    it('handles errors in startWatch', async () => {
      watchMocks.watch.mockImplementationOnce(() => {
  ...
  describe('updateProgress', () => {
    ...
    it('handles errors gracefully', async () => {
      watchMocks.updateProgress.mockImplementationOnce(() => {
  ...
  describe('downloadEpisode', () => {
    ...
    it('handles exceptions in download', async () => {
      dbMocks.getEpisodeById.mockImplementationOnce(() => {

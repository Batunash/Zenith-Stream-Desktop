...
describe('Media Service', () => {
    ...
    describe('initializeDatabase', () => {
        ...
        it('should catch and log errors', () => {
            db.syncFilesystemToDatabase.mockImplementation(() => { throw new Error('Sync Failed'); });
            initializeDatabase();
    ...
    describe('getSeries', () => {
        it('should fetch all series and format correctly without user', () => {
            db.getAllSeries.mockReturnValue([{
                ID: 1, TITLE: 'Test', POSTER_PATH: '/poster.jpg', BACKDROP_PATH: 'http://example.com/bg.jpg', RATING: 5, OVERVIEW: 'Overview'
            }]);
            db.getSeasonsWithEpisodes.mockReturnValue([{
                ID: 10, NAME: 'Season 1', SEASON_NUMBER: 1, episodes: [{
                    ID: 100, NAME: 'Ep 1', EPISODE_NUMBER: 1, DURATION: 120
                }]
            }]);
        ...
        it('should handle absolute POSTER_PATH and relative BACKDROP_PATH', () => {
            db.getAllSeries.mockReturnValue([{
                ID: 2, TITLE: 'Test2', POSTER_PATH: 'http://poster.jpg', BACKDROP_PATH: '/bg.jpg', RATING: 5, OVERVIEW: 'Overview'
            }]);
            db.getSeasonsWithEpisodes.mockReturnValue([]);
        ...
        it('should handle missing paths', () => {
            db.getAllSeries.mockReturnValue([{
                ID: 3, TITLE: 'Test3', RATING: 5, OVERVIEW: 'Overview'
            }]);
            db.getSeasonsWithEpisodes.mockReturnValue([]);
        ...
        it('should fetch series with user progress and format correctly', () => {
            db.getSeriesWithUserProgress.mockReturnValue([{
                ID: 1, TITLE: 'Test', POSTER_PATH: '/poster.jpg', RATING: 5
            }]);
            db.getSeasonsWithEpisodes.mockReturnValue([{
                ID: 10, NAME: 'Season 1', SEASON_NUMBER: 1, episodes: [{
                    ID: 100, NAME: 'Ep 1', EPISODE_NUMBER: 1, DURATION: 0, watched: true, progress: 0.5, watchTime: 60
                }]
            }]);
        ...
        it('should throw an error if DB throws', () => {
            db.getAllSeries.mockImplementation(() => { throw new Error('DB Crash'); });
    ...
    describe('getEpisodesBySeries', () => {
        ...
        it('should throw if DB throws', () => {
            db.getEpisodesBySeries.mockImplementation(() => { throw new Error('DB Error'); });

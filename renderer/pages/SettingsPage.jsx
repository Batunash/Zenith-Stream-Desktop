      ...
      <div style={styles.container}>
        <div style={styles.header}>
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', gap: '5px' }}>
            <button
              ...
              style={{ ...styles.langBtn, opacity: i18n.language === 'tr' ? 1 : 0.5 }}
              title="Türkçe"
            >
              TR
            </button>
            <button
              ...
              style={{ ...styles.langBtn, opacity: i18n.language === 'en' ? 1 : 0.5 }}
              title="English"
            >
              EN
            </button>
            <button
              ...
              style={{ ...styles.langBtn, opacity: i18n.language === 'es' ? 1 : 0.5 }}
              title="Español"
            >
              ES
            </button>
            <button
              ...
              style={{ ...styles.langBtn, opacity: i18n.language === 'de' ? 1 : 0.5 }}
              title="Deutsch"
            >
              DE
            </button>
            <button
              ...
              style={{ ...styles.langBtn, opacity: i18n.language === 'fr' ? 1 : 0.5 }}
              title="Français"
            >
              FR
            </button>
            <button
              ...
              style={{ ...styles.langBtn, opacity: i18n.language === 'ru' ? 1 : 0.5 }}
              title="Русский"
            >
              RU
            </button>
          ...
          <div style={styles.inputGroup}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button style={styles.browseBtn} onClick={handleSelectDir}>
                {t('settings.select_btn')}
              </button>
            </div>
          </div>
          <div style={styles.inputGroup}>
            <label style={styles.label}>
              {t('settings.api_key')} ({t('common.optional')})
            </label>
            <input
              style={styles.input}
              ...
              placeholder="API Key..."
            />
            <span style={styles.hint}>{t('settings.api_key_help')}</span>
          </div>
        </div>
        ...
        <div style={styles.section}>
          ...
          {(config.AI_PROVIDER || 'nvidia') === 'nvidia' && (
            <div style={styles.inputGroup}>
              <label style={styles.label}>
                {t('settings.nvidia_api_key')} ({t('common.optional')})
              </label>
              <input
                type="password"
                style={styles.input}
                ...
                placeholder="nvapi-..."
              />
              <span style={styles.hint}>{t('settings.nvidia_api_key_help')}</span>
            </div>
          )}
          {config.AI_PROVIDER === 'gemini' && (
            <div style={styles.inputGroup}>
              <label style={styles.label}>
                {t('settings.gemini_api_key')} ({t('common.optional')})
              </label>
              <input
                type="password"
                style={styles.input}
                ...
                placeholder="AIza..."
              />
              <span style={styles.hint}>{t('settings.gemini_api_key_help')}</span>
            </div>
          )}
        </div>
        ...
        <div style={styles.section}>
          ...
          <div style={{ display: 'flex', gap: '15px' }}>
            <button style={styles.actionBtn} onClick={handleSync}>
              🔄 {t('settings.sync_db')}
            </button>
            <button
              style={{

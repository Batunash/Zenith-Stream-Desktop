      ...
      <div style={styles.modal}>
        ...
        <div style={styles.body}>
          ...
          <div style={styles.controls}>
            ...
            <button style={styles.selectAllBtn} onClick={toggleSelectAll} disabled={busy}>
                ...
                return (
                  <div key={ep.path} style={styles.episodeRow}>
                    ...
                    <div style={styles.epInfo}>
                      ...
                      <span style={styles.epSize}>{(ep.size / (1024 * 1024)).toFixed(1)} MB</span>
                    </div>
                    <select
                    ...
                    {cfg.sourceType === 'translate' && (
                      ...
                      >
                        ...
                        {(episodeSubtitles[ep.path] || [])
                          .filter((s) => TEXT_TYPES.has(s.type))
                          .map((s) => (
          ...
          {busy && (
            <div style={styles.progress}>
              ...
              <span style={{ flex: 1 }}>
                ...
                {stage === 'translating' &&
                  t('auto_translate.progress_translating', { episode: currentEpisode })}
                {stage === 'converting' &&
                  t('auto_translate.progress_converting', { episode: currentEpisode })}

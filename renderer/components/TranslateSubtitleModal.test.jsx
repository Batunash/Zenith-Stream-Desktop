...
describe('TranslateSubtitleModal', () => {
    ...
    it('renders loading state initially if no preset analysis is provided', async () => {
        ...
        window.api.invoke.mockImplementation(() => new Promise(r => setTimeout(() => r({ success: true, data: { subtitles: [] } }), 100)));
    ...
    it('renders form immediately if preset analysis is provided', () => {
        ...
        render(<TranslateSubtitleModal videoPath="/my/video.mp4" presetAnalysis={preset} onClose={vi.fn()} />);
    ...
    it('handles close button', () => {
        ...
        render(<TranslateSubtitleModal videoPath="/my/video.mp4" presetAnalysis={{}} onClose={handleClose} />);

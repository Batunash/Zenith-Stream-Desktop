...
const mockApp = { isPackaged: false, getPath: vi.fn().mockReturnValue('C:\\Media'), relaunch: vi.fn(), exit: vi.fn() };
...
const _mockSqlConstructor = function MockDatabase() { return _mockSqlDb; };
...
Module.prototype.require = function(id) {
  if (id === 'electron') {
    return { app: mockApp, ipcMain: mockIpcMain, dialog: mockDialog, BrowserWindow: mockBrowserWindow };
  }
  if (id === 'fs') {
    return mockFs;
  }
...
vi.mock('electron', () => ({
  ...
  default:      { app: mockApp, ipcMain: mockIpcMain, dialog: mockDialog, BrowserWindow: mockBrowserWindow }
}));
